...
int main(int argc, char **argv){
    ...
    kin.inputFile("../data/VSM/2D_new_force_model/traj/"+filename + ".txt", &matrix);
    ...
    int num_H = kin.HerInter(Q,Qdot,Qs,dt,1.0,&interpolated_data);
    ...
    dataFile.open("../data/VSM/2D_new_force_model/output_files/"+filename+"_output.csv");
