...
struct qt_meta_stringdata_QtGnuplotEventHandler_t {
    QByteArrayData data[7];
    char stringdata0[87];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QtGnuplotEventHandler_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QtGnuplotEventHandler_t qt_meta_stringdata_QtGnuplotEventHandler = {
    {
QT_MOC_LITERAL(0, 0, 21), // "QtGnuplotEventHandler"
QT_MOC_LITERAL(1, 22, 9), // "connected"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 12), // "disconnected"
QT_MOC_LITERAL(4, 46, 13), // "newConnection"
QT_MOC_LITERAL(5, 60, 9), // "readEvent"
QT_MOC_LITERAL(6, 70, 16) // "connectionClosed"

    },
    "QtGnuplotEventHandler\0connected\0\0"
    "disconnected\0newConnection\0readEvent\0"
    "connectionClosed"
};
...
void QtGnuplotEventHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QtGnuplotEventHandler::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QtGnuplotEventHandler::connected)) {
                *result = 0;
            }
        }
        {
            typedef void (QtGnuplotEventHandler::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QtGnuplotEventHandler::disconnected)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject QtGnuplotEventHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtGnuplotEventHandler.data,
      qt_meta_data_QtGnuplotEventHandler,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtGnuplotEventHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtGnuplotEventHandler.stringdata0))
