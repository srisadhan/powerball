...
const QMetaObject QtGnuplotScene::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_QtGnuplotScene.data,
      qt_meta_data_QtGnuplotScene,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtGnuplotScene::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtGnuplotScene.stringdata0))
        return static_cast<void*>(const_cast< QtGnuplotScene*>(this));
    if (!strcmp(_clname, "QtGnuplotEventReceiver"))
        return static_cast< QtGnuplotEventReceiver*>(const_cast< QtGnuplotScene*>(this));
